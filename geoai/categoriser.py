...
FILENAME_RULES = {
    ...
    "geochemical": ["geochem","assay","sample","geoch","stream_sed","soil_","lithogeochem",
                    "element","ppm","ppb","wt_pct","oxide","regolith"],
    "drillhole":   ["collar","survey","litholog","dh_","drill","hole","interval","downhole",
                    "from_to","from","assay_pivot","lith","alteration","structure"],
